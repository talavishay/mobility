...
To use these stylesheets, rename the files and mobility with the name of your theme.
...
mobility-alpha-default-narrow.css  
...
mobility-alpha-default-normal.css
...
mobility-alpha-default-wide.css
